...
public class ServiceLocator {
    ...
    public static Session getHibernateSession(String jndiSessionFactoryName) throws ServiceLocatorException {
        ...
        try
        {
		    session = getHibernateSessionFactory(jndiSessionFactoryName).getCurrentSession();
        }
        catch (Exception e)
        {
    ...
    /**
     * Gets a JavaMail <code>Session</code> using the given JNDI name.
     *
     * @param javaMailSessionJndiName The JavaMail <code>Session</code>'s JNDI name.
     *
     * @return Session The JavaMail <code>Session</code>.
     *
     * @throws ServiceLocatorException If there are JNDI lookup problems.
     *
